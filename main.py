...
def main(s0):
    global planets
    s = 'C:\\project python\\Project\\Maps2/' + s0 + '.txt'
...
def lets_play():
    ...
    filename = PhotoImage(file="C:\\project python\\Project\\Images\\menu.png")
...
def game():
    ...
    canvas.delete("all")
    filename = PhotoImage(file="C:\\project python\\Project\\Images\\fon.png")
